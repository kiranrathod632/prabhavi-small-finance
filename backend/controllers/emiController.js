...
import { notifyEMIUpdate } from '../services/notificationService.js';
...
import { sendEmiPaidSms } from '../services/smsService.js';
...
export const payEMI = asyncHandler(async (req, res) => {
  ...
  const totalAmount = emi.amount + (emi.penalty || 0);
