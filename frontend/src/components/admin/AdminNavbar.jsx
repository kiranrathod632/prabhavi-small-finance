    ...
    <header className="sticky top-0 z-30 border-b border-accent-400/10 bg-white/70 dark:bg-primary-950/70 backdrop-blur-xl">
      <div className="flex items-center justify-between px-4 sm:px-6 py-3 gap-3">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          <LanguageSelector className="w-24 sm:w-32" onChange={updateLanguage} />
          ...
          <Link
            to={`${base}/profile`}
            className="flex items-center gap-2.5 pl-2.5 sm:pl-3 ml-0.5 border-l border-primary-200 dark:border-primary-700"
          >
